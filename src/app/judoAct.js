...
module.exports.judoBio = function() {
  ...
  function judoText() {
    var bio =
      '西元二零二零年在台灣由G集團主辦兩岸的人工智慧研討會出現了前所未見的混亂,佳滑心想,可惡啊!這群台灣人到底在搞什麼鬼....佳滑本想匆匆地離去,但是乘上的計程車司機卻突然熄火,佳滑叫罵:"喂!司機!你搞什麼鬼!開車啊!",只見計程車司機拿出了一把巨大的武器,靠!垃圾真是打也打不完,佳滑說.於是佳滑也開了車門下車,這時佳滑亮出他的武器,"我這把人工智慧砍刀要價五億人民幣才剛訂做的.....",佳滑無奈地擺出戰鬥姿態,戰鬥眼看就要開始了...';
...
module.exports.judoTest = function() {
  var judoTest = document.querySelector('.judo-test');
  var click = 1;
  judoTest.onclick = function() {
    return (function() {
      if (click > 3) click = 1;
      switch (click) {
        case 1:
