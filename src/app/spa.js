...
awake.command = {
  ...
  nameSvg: function() {
    var svg =
      '<svg width="150" height="200" viewBox="0 0 300 900"><pattern id="rain" viewBox="100 100 100 100" patternUnits="userSpaceOnUse" width="150" height="200" x="0" y="150"><image xlink:href="" width="100" height="150"/></pattern><text text-anchor="middle" x="50%" y="50%" dy=".35em" class="text">雨珊</text></svg>';
...
awake.shanLiAwaken = {
  year: '西元二零二七年',
  location:
    '位於:24.09.25.98北,120.38.44.90東,拔海高度90公尺的一間老舊的生化人研究中心',
...
awake.app = {
  calendar:
    '<div class="month"><span class="close">X</span><ul><li class="prev">❮</li><li class="next">❯</li><li class="full-month-cycle">August<br><span class="full-year-cycle">2018</span></li></ul></div><ul class="weekdays"><li>Mo</li><li>Tu</li><li>We</li><li>Th</li><li>Fr</li><li>Sa</li><li>Su</li></ul><ul class="days"><li>1</li><li>2</li><li>3</li><li>4</li><li>5</li><li>6</li><li>7</li><li>8</li><li>9</li><li>10</li><li>11</li><li>12</li><li>13</li><li>14</li><li>15</li><li>16</li><li>17</li><li>18</li><li>19</li><li>20</li><li>21</li><li>22</li><li>23</li><li>24</li><li>25</li><li>26</li><li>27</li><li>28</li><li>29</li><li>30</li><li>31</li></ul>',
  toolBox:
    '<div class="tool-box"><span class="title">道具箱</span><div class="tool-set-one"></div><div class="tool-set-two"></div><div class="tool-set-three"></div><div class="tool-set-four"></div><div class="tool-set-five"></div><div class="tool-set-six"></div><div class="tool-set-seven"></div><div class="tool-set-eight"></div><div class="tool-set-nigh"></div><div class="tool-btn-down"></div><div class="tool-btn-up"></div>',
  ...
  toolApp: function() {
    ...
    shanBtn.insertAdjacentHTML(
      'afterend',
      '<article class="tool-boxcontrol"></article>',
    );
  ...
  special:
    '<div class="special-btn"><div class="special-one"></div><div class="special-two"></div><div class="special-three"></div><div class="special-four"></div><div class="special-five"></div></div>',
  specialApp: function() {
    var mainBc = obj.get('.main-boxcontrol');
    mainBc.insertAdjacentHTML(
      'afterend',
      '<article class="special-boxcontrol"></article>',
    );
...
awake.command.awakeFirst().style.transition =
  'all 1s cubic-bezier(.58,-0.07,.99,-0.69)';
awake.command.awakeSecond().style.transition =
  'all 1s cubic-bezier(.58,-0.07,.99,-0.69)';
awake.command.awakeThird().style.transition =
  'all 1s cubic-bezier(.58,-0.07,.99,-0.69)';
awake.command.awakeFourth().style.transition =
  'all 1s cubic-bezier(.58,-0.07,.99,-0.69)';
awake.command.awakeFifth().style.transition =
  'all 1s cubic-bezier(.58,-0.07,.99,-0.69)';
awake.command.prologue().style.transition =
  'all 1s cubic-bezier(.58,-0.07,.99,-0.69)';
awake.command.location().style.transition =
  'all 1s cubic-bezier(.58,-0.07,.99,-0.69)';
awake.command.epilogue().style.transition =
  'all 1s cubic-bezier(.58,-0.07,.99,-0.69)';
