...
import dude from './models/Dude/dude.babylon';
...
module.exports.startGame = function() {
  ...
  function startGameEX() {
    ...
    var toRender = function() {
      ...
      if (heroDude) heroDude.Dude.move();
      if (scene.dudes) {
  ...
  function CreateGround(scene) {
    var groundImg = require('../images/hmap1.png');
    ...
    function OnGroundCreated() {
      ...
      var yushan = require('../images/yu0725.jpg');
      groundMaterial.diffuseTexture = new BABYLON.Texture(yushan, scene);
  ...
  function createFollowCamera(scene, target) {
    ...
    camera.radius = 6000; // how far from the object to follow
    camera.heightOffset = 3000; // how high above the object to place the camera
  ...
  function createHeroDude(scene) {
    var d = path.join(__dirname, 'src', 'models', 'Dude/');
  ...
  function createPlane() {
    var plane = new BABYLON.PlaneGeometry('plane', scene, 10000, false);
  }
