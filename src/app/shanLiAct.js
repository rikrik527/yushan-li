...
module.exports.shanAppear = function() {
  var shan =
    '<section class="shan-li-bubble-boxcontrol"><div class="shan-li-text-bubble"></div><div class="shan-li-bubble1"><div class="shan-li-bubble2"><div class="shan-li-bubble3"></div></div></div></section><div class="shan-li-hair1"></div><div class="shan-li-hair2"></div><div class="shan-li-hair3"></div><div class="shan-li-head"><div class="shan-li-eyebrow"></div><div class="shan-li-eyebrow2"></div><div class="shan-li-eye"><div class="shan-li-eyeball"></div></div><div class="shan-li-eye2"><div class="shan-li-eyeball2"></div></div><div class="shan-li-nose"></div><div class="shan-li-lips"></div><div class="shan-li-mouth"><div class="shan-li-teeth"></div></div><div class="shan-li-lips2"></div></div><div class="shan-li-neck"></div><div class="shan-li-body"><div class="shan-li-mimi"></div><div class="shan-li-mimi2"></div></div><div class="shan-li-arm"></div><div class="shan-li-arm2"></div><div class="shan-li-lowarm"><div class="shan-li-hand"><div class="shan-mobile"></div></div></div></div><div class="shan-li-lowarm2"><div class="shan-li-hand2"><div class="shan-li-umbrella rotatey"><div class="shan-li-umbrella2 rotatey"><div class="shan-li-handle"></div></div></div></div></div></div><div class="shan-li-stomache"></div><div class="shan-li-peegu"></div><div class="shan-li-leg"></div><div class="shan-li-leg2"></div><div class="shan-li-lowleg"><div class="shan-li-feet"></div></div><div class="shan-li-lowleg2"><div class="shan-li-feet2"></div></div><div class="shan-li-book"><div class="shan-li-book-left"></div><div class="shan-li-book-right"></div><div class="shan-li-book-middle"></div></div>';

  var shanBtn = obj.get('.shan-btn');
  shanBtn.insertAdjacentHTML(
    'afterbegin',
    '<article class="shan-li-boxcontrol"></article>',
  );
  ...
  window.setInterval(() => {
    if (letterCount === 0 && waiting === false) {
      ...
      window.setTimeout(function() {
        shanLiTextBubble.style.visibility = 'hidden';
        for (var i = 0; i < shanLiBubble.length; i++) {
          shanLiBubble[i].style.visibility = 'hidden';
        }
        var usedWords = words.shift();
    ...
    // }
      ...
      $('.shan-li-text-bubble').css('visibility', 'visible');
      for (var a = 0; a < shanLiBubble.length; a++) {
        shanLiBubble[a].style.visibility = 'visible';
      }
      target.innerHTML = words[0].substring(0, letterCount);
      letterCount += x;
    }
...
module.exports.shanDialog = function() {
  ...
  shanBtn.insertAdjacentHTML(
    'afterbegin',
    '<ul class="shan-talk"><input class="user-talk" type="text"><div class="user-btn">送出</div></ul>',
  );
  ...
  var shanGreeting = (function() {
    ...
    return function() {
      if (!executed) {
        ...
        var greeting =
          userGreeting[Math.floor(Math.random() * userGreeting.length)];
        setTimeout(() => {
          $('.shan-talk').append(userConversationLi);

          userConversationLi.innerHTML = user + greeting;
        ...
        if (greeting.indexOf('雨珊姐姐') > -1) {
          ...
          setTimeout(function() {
            $('.shan-talk').append(shanConversationLi);
            shanConversationLi.innerHTML =
              yushan +
              shanGreetings[Math.floor(Math.random() * shanGreetings.length)];
            shanOpenEye();
          }, yushanTime);
        }
      }
